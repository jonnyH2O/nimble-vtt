...
export const MESSAGE_TYPES = {
  ...
  ADD_TOKEN: 'ADD_TOKEN',
  ADD_SHADOW_TOKEN: 'ADD_SHADOW_TOKEN', // TEMPORARY: For shadow tokens
  REMOVE_SHADOW_TOKEN: 'REMOVE_SHADOW_TOKEN', // TEMPORARY: For shadow tokens
  UPDATE_TOKEN_DATA: 'UPDATE_TOKEN_DATA',
